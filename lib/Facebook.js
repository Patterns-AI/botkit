...
function Facebookbot(configuration) {
    ...
    var messenger_profile_api = {
        ...
        postAPI: function(message, page) {
            let access_token = page ? configuration.access_token_cb(page) : configuration.access_token;

            var uri = 'https://' + api_host + '/' + api_version + '/me/messenger_profile?access_token=' + access_token;
        ...
        getAPI: function(fields, page, cb) {
            ...
            var uri = 'https://' + api_host + '/' + api_version + '/me/messenger_profile?fields=' + fields + '&access_token=' + access_token;
        ...
        get_messenger_code: function(image_size, cb, ref, page) {
            ...
            var uri = 'https://' + api_host + '/' + api_version + '/me/messenger_codes?access_token=' + access_token;
    ...
    var attachment_upload_api = {
        upload: function(attachment, page, cb) {
            ...
            var uri = 'https://' + api_host + '/' + api_version + '/me/message_attachments?access_token=' + access_token;
    ...
    var tags = {
        get_all: function(page, cb) {
            let access_token = page ? configuration.access_token_cb(page) : access_token;
    ...
    var nlp = {
        ...
        postAPI: function(value, custom_token, page) {
            ...
            var uri = 'https://' + api_host + '/' + api_version + '/me/nlp_configs?nlp_enabled=' + value + '&access_token=' + access_token;
    ...
    var user_profile = function(uid, fields, page, cb) {
        ...
        return new Promise(function(resolve, reject) {
            ...
            var uri = 'https://' + api_host + '/' + api_version + '/' + uid + '?fields=' + fields + '&access_token=' + access_token;
